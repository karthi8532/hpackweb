...
class ReportHeaderPage extends StatefulWidget {
  final TextEditingController searchController;

  ReportHeaderPage({super.key, required this.searchController, this.onRowTap});
  void Function(ApprovalDetail)? onRowTap;
  @override
  State<ReportHeaderPage> createState() => ReportDetailListPage();
}

class ReportDetailListPage extends State<ReportHeaderPage> {
  ...
  Future<void> fetchApprovalList() async {
    ...
    try {
      final response = await ApiService.empgetAllList({
